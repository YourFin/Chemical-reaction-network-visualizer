...
<!-- generated with COPASI 4.22 (Build 170) (http://www.copasi.org) at 2017-11-19 18:03:04 UTC -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2017-11-19T12:00:35Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
    ...
    <ListOfMetabolites>
      ...
      <Metabolite key="Metabolite_5" name="Z" simulationType="reactions" compartment="Compartment_0">
      </Metabolite>
    </ListOfMetabolites>
    <ListOfReactions>
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[X]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[B]" value="17" type="Species" simulationType="reactions"/>
    ...
    <InitialState type="initialState">
      0 0 0 0 17 20 1.0000000000000001e-018 
    </InitialState>
  </Model>
  <ListOfTasks>
